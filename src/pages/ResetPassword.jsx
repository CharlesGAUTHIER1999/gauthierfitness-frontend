...
export default function ResetPassword() {
    ...
    async function submit(e) {
        ...
        try {
            ...
            if (validation && typeof validation === "object") {
                ...
                setError(e?.response?.data?.message || "Impossible de réinitialiser le mot de passe. Le lien est peut-être expiré.");
            }
        } finally {
            setLoading(false);
        }
    ...
    return (<form onSubmit={submit} style={{maxWidth: 320, margin: "50px auto"}}>
