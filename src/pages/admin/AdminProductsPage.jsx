...
export default function AdminProductsPage() {
    ...
    return (<div className="adm-page">
        ...
        {loading ? (<p className="adm-loading">Chargement...</p>) : (<div className="adm-table-wrapper">
            <table className="adm-table">
                ...
                {products.length === 0 ? (<tr>
                    ...
                    <td>
                        {p.is_customizable ? (<span className="adm-badge adm-badge-blue">
                                                    {p.customization?.mode ?? "oui"}
                                                </span>) : (<span className="adm-badge adm-badge-grey">Non</span>)}
                    </td>
        ...
        {data && data.last_page > 1 && (<div className="adm-pagination">
            <button
                type="button"
