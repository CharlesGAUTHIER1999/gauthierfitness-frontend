const TEMPLATES = [{
    id: null, name: "Aucun", description: "Pas de décor de fond",
}, {
    id: "basic-front-template", name: "Rayures / classique", description: "Placement centré sur la face avant",
}, {
    id: "clean-front-template", name: "Minimal", description: "Rendu plus sobre et propre",
},];
