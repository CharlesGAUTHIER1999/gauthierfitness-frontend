...
const DEFAULT_3D_CONFIG = {
    glb: "/models/tshirt.glb", meshMode: "pick", activeMeshIndex: 2, uvZones: {
...
const CONFIGS_BY_PRODUCT_NAME = {
    "T-shirt Training": {
        productType: "tshirt", availableColors: ["white", "black", "grey"], templates: DEFAULT_TEMPLATES, model3d: {
            glb: "/models/tshirt.glb", meshMode: "pick", activeMeshIndex: 2, uvZones: {
                logo: {x: 0.385, y: 0.18, w: 0.13, h: 0.13, transform: "mirror_y"},
                front_center: {x: 0.35, y: 0.33, w: 0.20, h: 0.14, transform: "mirror_y"},
                back_name: {x: 0.40, y: 0.50, w: 0.30, h: 0.10, transform: "mirror_y"},
    ...
    "T-shirt Oversize": {
        productType: "tshirt", availableColors: ["white", "black", "grey"], templates: DEFAULT_TEMPLATES, model3d: {
            glb: "/models/tsoversized.glb", meshMode: "all", activeMeshIndex: 0, uvZones: {
    ...
    "Sweat Classic": {
        productType: "sweat", availableColors: ["white", "black", "grey"], templates: DEFAULT_TEMPLATES, model3d: {
            glb: "/models/sweatclassic.glb", meshMode: "all", activeMeshIndex: 0, uvZones: {
            ...
            }, transformFallback: "mirror_x", templateChest: {
                cx: 0.70, cy: 0.72, w: 0.18, h: 0.16,
            },
        }, views: {
            front: {
    ...
    "Sweat Zippe": {
        productType: "sweat", availableColors: ["white", "black", "red"], templates: DEFAULT_TEMPLATES, model3d: {
            glb: "/models/sweatzippe.glb", meshMode: "all", activeMeshIndex: 0, uvZones: {
            ...
            }, transformFallback: "none", templateChest: {
                cx: 0.22, cy: 0.75, w: 0.18, h: 0.20,
            },
        }, views: {
            front: {
    ...
    "Veste Classic": {
        productType: "veste", availableColors: ["white", "black", "red"], templates: DEFAULT_TEMPLATES, model3d: {
            glb: "/models/vesteclassic.glb", meshMode: "all", activeMeshIndex: 0, uvZones: {
            ...
            }, transformFallback: "mirror_y", templateChest: {cx: 0.20, cy: 0.65, w: 0.14, h: 0.14},
        }, views: {
            front: {
    ...
    "Veste Coupe-Vent": {
        productType: "veste", availableColors: ["green", "blue", "cyan"], templates: DEFAULT_TEMPLATES, model3d: {
            glb: "/models/vestecoupevent.glb", meshMode: "all", activeMeshIndex: 0, uvZones: {
            ...
            }, transformFallback: "rotate_180", templateChest: {cx: 0.35, cy: 0.80, w: 0.18, h: 0.14},
        }, views: {
            front: {
...
// Looks up customizer config entry
...
// Print/design/logo zones for product's view
export function getProductCustomizerViewConfig(product, view = "front", templateId = null) {
    ...
    const templateViewOverride = templateId && baseConfig?.templateOverrides?.[templateId]?.[safeView] ? baseConfig.templateOverrides[templateId][safeView] : null;

    if (!baseViewConfig) return null;

    return {
        ...baseViewConfig, ...(templateViewOverride || {}),
    };
}
...
// Returns product's 3D model block
